...
def normalise_input(user_input):
    ...
    'help'
    """
    input_normalised = remove_spaces(remove_punct(user_input)).lower()
...
def menu(exits):
    ...
    while True:
        ...
        print_menu(exits)
        # Read player's input
        player_choice = normalise_input(input())
        # Normalise the input
        valid = is_valid_exit(exits, player_choice)
        # Check if the input makes sense (is valid exit)
        #is_valid_exit(exits, player_choice)
